...
const ReportExport = {
    ...
    downloadCurrentReport() {
        ...
        const filename = `${reportNames[this.currentReportType] || '报表'}_${dateStr}.doc`;
        
        // 生成Word格式的HTML文档
        const wordContent = this.generateWordDocument(this.currentReportContent, reportNames[this.currentReportType]);
        ...
        this.showToast('Word报表下载成功！', 'success');
    },
